<?
	...
	echo "{\"totalCount\":[" . mssql_num_rows($request) . "],\"patches\":[";
	...
	while ($rs = mssql_fetch_array($request)) {
		...
		echo "\"ServerMissingCritical\":\"" . $rs['ServerMissingCritical'] . "\",";	
		echo "\"NonServerMissingCritical\":\"" . $rs['NonServerMissingCritical'] . "\"";	
		echo "}";
	}
	echo "]}";
