<?
	...
	echo "{\"totalCount\":[" . mssql_num_rows($request) . "],\"components\":[";
	...
	while ($rs = mssql_fetch_array($request)) {
		...
		echo "\"HIDS\":\"" . $rs['HIDS'] . "\",";	
		echo "\"Entrust\":\"" . $rs['Entrust'] . "\",";	
		echo "\"Navajo\":\"" . $rs['Navajo'] . "\",";	
		echo "\"Firewall\":\"" . $rs['Firewall'] . "\",";	
		echo "\"MissingBigfix\":\"" . $rs['MissingBigfix'] . "\"";	
		echo "}";
	}
	echo "]}";
